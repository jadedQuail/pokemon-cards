...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-ivMB2vrC.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-JcdXfCG6.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-vk_nO2f_.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, navigateTo as a, useRuntimeConfig as b, resolveUnrefHeadInput as c, entry$1 as default, injectHead as i, nuxtLinkDefaults as n, resolveRouteObject as r, useRouter as u };
